...
const MultipleChoiceItem = ({id,deleteQuestion, changeOption, option}:{id:number, deleteQuestion:(id:number)=>void, changeOption:(e:React.ChangeEvent<HTMLInputElement>)=>void, option:string}) => {
    ...
    return(
        <div 
            ...
            <div className="flex flex-1 items-center">
                ...
                <input className="flex-1 outline-none text-[15px]" type="text" value={option} onChange={changeOption} />
            </div>
            <button 
