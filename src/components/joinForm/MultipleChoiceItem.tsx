...
const MultipleChoiceItem = ({id}:{id:number}) => {
    ...
    return(
        <div 
            ...
            <div className="flex items-center">
                ...
                <input className="flex-1 outline-none text-[15px]" type="text" />
            </div>
            <button className="text-black cursor-pointer hover:bg-gray-100 p-[5px] rounded-sm self-center" {...listeners} aria-label="drag handle">
                <XIcon />
            </button>
        </div>
    )
