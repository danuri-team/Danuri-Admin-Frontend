        ...
        {orderNumber === 1 ? (
          <EmailForFindPassword
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
              dispatch({ type: "CHANGE", payload: { key: "phone", value: e.target.value } })
            }
          ...
          <VerifyCode
            value={findForm.code}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
              dispatch({ type: "CHANGE", payload: { key: "code", value: e.target.value } })
            }
          ...
          <ChangePassword
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>, key: string) =>
              dispatch({ type: "CHANGE", payload: { key: key, value: e.target.value } })
            }
