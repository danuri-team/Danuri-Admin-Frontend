    ...
    return(
        <div className="w-full">
            ...
            <div className="flex-1 mr-[50px] ml-[50px] text-nowrap">
                ...
                <div className="w-sm">
                    <CustomInput label="회사" value={infoForm.company} onChange={(e)=>infoDispatch({type:'CHANGE', payload: {key:'company', value:e.target.value}})} />
                    <CustomInput label="이메일" value={infoForm.email} valid={isValidEmail(infoForm.email)} onChange={(e)=>infoDispatch({type:'CHANGE', payload: {key:'email', value:e.target.value}})}/>
                    <CustomInput label="전화번호" value={infoForm.phone} valid={isValidEmail(infoForm.phone)} onChange={(e)=>infoDispatch({type:'CHANGE', payload: {key:'phone', value:e.target.value}})}/>
                </div>
